...
def forward(model, loader, device, writer, epoch, optimizer=None, train_flag=True, max_item_id=0, last_update=0):
    ...
    if train_flag:
        ...
        # SARA
        print('### TEST ###')
        print('loss/test_loss', mean_loss.item(), epoch)
        print('index/hit20', hit20, epoch)
        print('index/mrr20', mrr20, epoch)
        print('index/hit10', hit10, epoch)
        print('index/mrr10', mrr10, epoch)
        print('index/hit5', hit5, epoch)
        print('index/mrr5', mrr5, epoch)
        print('index/hit1', hit1, epoch)
        print('index/mrr1', mrr1, epoch)
...
def forward_wass(model, loader, device, max_item_id=0):
    ...
    for i, batch in enumerate(loader):
        ...
        distance += list(
            wasserstein_distance(score, target) for score, target in zip(scores.cpu().numpy(), targets_1hot))
